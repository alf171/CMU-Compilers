...
fn storeAssignmentTarget(lhs: *PyObject, rhs_value: TypedOperand, irBuilder: *IrBuilder, alloc: std.mem.Allocator) !void {
    ...
    switch (expr) {
        ...
        .Name => {
            ...
            try irBuilder.local_values.put(local, try rhs_value.clone(alloc));
                    ...
                    .Constant => {
                        ...
                        switch (constant) {
                            ...
                            .composite => |comp| {
                                ...
                                try result.append(alloc, .{ .top = dst });
        ...
        switch (b) {
            .Print => {
                ...
                try irBuilder.emit(Instruction{ .print = .{
                    ...
                    .end = if (end) |e| try e.clone(alloc) else null,
                } }, alloc);
                return src;
            },
            .Write => {
