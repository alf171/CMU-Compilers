...
pub fn run(ir_program: *IrProgram, graph: *igraph.IGraph, init_program: *AllocProgram, should_coalesce: bool, register_mask: u32, alloc: Allocator, stdout: ?*Writer) !RunResult {
    if (should_coalesce) {
